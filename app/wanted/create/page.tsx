    ...
    <main className="relative min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="mb-6 text-center">
          <Link
            href="/wanted"
            className="inline-flex items-center gap-2 rounded-lg border border-zinc-800 bg-zinc-900/60 px-3 py-2 text-sm text-[var(--foreground)] transition hover:border-zinc-700 hover:bg-zinc-800/60 mb-5"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 text-[var(--foreground)] placeholder:text-zinc-600 outline-none transition-all duration-200 focus:border-sky-500/40 focus:bg-white/[0.05] focus:ring-2 focus:ring-sky-500/10"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full rounded-xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 text-[var(--foreground)] placeholder:text-zinc-600 outline-none transition-all duration-200 focus:border-sky-500/40 focus:bg-white/[0.05] focus:ring-2 focus:ring-sky-500/10 resize-none"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="0"
                      className="w-full rounded-xl border border-white/[0.06] bg-white/[0.03] pl-8 pr-4 py-3 text-[var(--foreground)] placeholder:text-zinc-600 outline-none transition-all duration-200 focus:border-sky-500/40 focus:bg-white/[0.05] focus:ring-2 focus:ring-sky-500/10"
                    />
                  </div>
                </div>
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-zinc-700 bg-zinc-800/80 px-4 py-3 text-[var(--foreground)] outline-none transition-all duration-200 focus:border-sky-500/40 focus:ring-2 focus:ring-sky-500/10 appearance-none cursor-pointer"
                  >
              ...
              {/* Awhina panel */}
              <div className="rounded-2xl border border-[#D6ECFF] bg-gradient-to-br from-sky-500/[0.02] to-sky-500/[0.01] p-4 dark:border-sky-500/20 dark:from-sky-500/[0.04] dark:to-zinc-950/80">
