  ...
  return (
    <main className="relative min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        {/* Sky Hustlers */}
        <div className="mt-6 rounded-2xl border border-emerald-500/10 bg-gradient-to-b from-emerald-500/3 to-transparent p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-lg">🚀</span>
                <h2 className="text-sm font-bold text-[var(--foreground)]">Sky Hustlers</h2>
              </div>
              <p className="mt-1 text-xs text-zinc-500">Promote listings and earn commission on every sale you refer.</p>
            </div>
            <Link href="/dashboard/hustler" className="shrink-0 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-400 px-4 py-2 text-[11px] font-bold text-white shadow-lg shadow-emerald-500/20 transition hover:shadow-xl active:scale-[0.97]">
              View Dashboard
            </Link>
          </div>
          <div className="mt-3 flex gap-2">
            <Link href="/promote" className="flex-1 rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-3 py-2 text-center text-[11px] font-bold text-emerald-400 hover:bg-emerald-500/10 transition">
              Browse Listings
            </Link>
          </div>
        </div>
