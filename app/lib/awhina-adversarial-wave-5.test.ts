...
describe("adversarial NZ wave5 — price/budget traps (parseListingPriceFromMessage)", () => {
  ...
  it.fails('FAIL: "max 280" wanted cap is 280 not se/2020', () => {
  ...
  it.fails('FAIL: "under 900 nelson" wanted cap is 900 not 5d', () => {
  ...
  it.fails('FAIL: "under 400 gisborne" wanted cap is 400', () => {
    expect(parseListingPriceFromMessage("looking for a kayak under 400 gisborne")).toBe("400");
  });

  it.fails('FAIL: "max 300" beats around 280 on a drone wanted line', () => {
  ...
  it('"240pw bond $960" weekly 240 beats bond dollars', () => {
