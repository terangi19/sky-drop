...
const KNOWN_FAILURE_IDS = new Set<string>([
  ...
  "wanted-iso-macbook-max-no-scams",
  "wanted-looking-for-pram-post-ad",
  "wanted-iso-switch-not-selling-mine",
  "wanted-wtb-gopro-max-akl",
  "wanted-long-ipad-budget-walk",
  "wanted-bike-serious-only-not-desperate",
  "wanted-around-vs-paid-history",
  "rental-2bed-wellie-bond-weeks",
  "rental-generator-hire-not-sale",
  "rental-van-hire-or-sell-hire-wins",
  "rental-scaffold-daily-and-weekly",
  "rental-room-bond-dollars-not-weekly",
  ...
  // multi7-price-maybe-firm-nah-final-ipad PASSES on current main — keep as it().
]);
...
describe("adversarial NZ wave4 — price/budget traps (parseListingPriceFromMessage)", () => {
  ...
  it.fails('FAIL: "ipad air 64gb hammers 380" → 380 (hammers slang must not drop asking)', () => {
  ...
  it.fails('FAIL: "pixel 7 128gb black wellie 450" → 450', () => {
  ...
  it.fails('FAIL: "ps4 slim dunners 180" → 180', () => {
  ...
  it.fails('FAIL: "520 a week bond 3 weeks" is weekly 520, not bond-weeks 3 as dollars', () => {
  ...
  it.fails('FAIL: "just hiring 150 a day" is 150 not 2017 / 18000', () => {
    const msg =
...
describe("adversarial NZ wave4 — semantic correction + pending-slot traps", () => {
  ...
  it.fails("FAIL: pending colour must NOT eat '256gb actually' as a colour", () => {
    const r = interpretSemanticTurn({
