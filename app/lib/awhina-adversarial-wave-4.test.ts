 ...
 *
 * Converted after Fixer production follow-up (this commit):
 *   wanted-wtb-xbox-around-budget, wanted-long-ipad-budget-walk,
 *   wanted-bike-serious-only-not-desperate, wanted-around-vs-paid-history,
 *   rental-van-hire-or-sell-hire-wins, rental-triton-just-hiring-not-sale,
...
describe("adversarial NZ wave4 — semantic fact model", () => {
  it("no scams / serious only / no timewasters are instructions on a WTB xbox", () => {
  ...
  it("dont put my max / just say wanted ipad are instructions not public facts", () => {
