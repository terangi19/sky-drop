...
export const FAB_DOCK_POSITION =
  "fixed z-[10003] bottom-[calc(1.5rem+env(safe-area-inset-bottom,0px))] right-[calc(1rem+env(safe-area-inset-right,0px))] max-md:bottom-[calc(6rem+env(safe-area-inset-bottom,0px))] max-md:right-4";
