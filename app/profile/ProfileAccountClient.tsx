      ...
      <section className={`${PROFILE_SHELL} pb-10 pt-2 sm:pt-3`}>
        <div className="space-y-5">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-0.5 text-sm text-[var(--muted)]">
                    Edit profile, notifications, privacy, and payments
                  </p>
                </div>
              </div>
          ...
          <div className="rounded-2xl border border-[var(--card-border)] bg-[var(--card)]">
            <div
              className="group relative h-14 cursor-pointer overflow-hidden sm:h-16"
            ...
            <div className="relative px-4 pb-4 pt-0 sm:px-5 sm:pb-5">
              <div className="-mt-8 flex flex-col gap-3 sm:-mt-9 sm:flex-row sm:items-end sm:gap-4">
                <div className="flex min-w-0 flex-1 items-end gap-3">
                  ...
                  >
                    {avatarUrl ? (
                      <img
                        src={avatarUrl}
                        alt=""
                        className="h-16 w-16 rounded-xl border-[3px] border-[var(--card)] object-cover sm:h-[4.5rem] sm:w-[4.5rem]"
                      />
                    ) : (
                      <div className="flex h-16 w-16 items-center justify-center rounded-xl border-[3px] border-[var(--card)] bg-[var(--soft-card)] text-xl font-bold text-sky-500 sm:h-[4.5rem] sm:w-[4.5rem] sm:text-2xl">
                        {initial}
                      </div>
                    )}
                  ...
                  <div className="min-w-0 flex-1 pb-0.5">
                    ...
                    <p className="mt-1.5 flex flex-wrap items-center gap-x-2 gap-y-0.5 text-xs text-[var(--text-secondary)] sm:text-sm">
          ...
          {contentTab === "listings" && (
            <section aria-labelledby="profile-listings-heading" className="space-y-3">
              <div className="flex items-end justify-between gap-3">
                ...
                <Link href="/post/ai" className="ml-auto text-xs font-semibold text-sky-500 transition hover:text-sky-400">
                  + New listing
                </Link>
              </div>
          ...
          {contentTab === "reviews" && (
            <section aria-labelledby="profile-reviews-heading" className="space-y-3">
              ...
              {reviewsLoading ? (
                ...
                <p className="py-8 text-center text-sm text-[var(--muted)]">No reviews yet.</p>
              ) : (
          ...
          {contentTab === "following" && (
            <section aria-labelledby="profile-following-heading" className="space-y-3">
              ...
              {followingLoading && followingList.length === 0 ? (
                ...
                <p className="py-8 text-center text-sm text-[var(--muted)]">Not following anyone yet.</p>
              ) : (
                <div className="flex flex-wrap gap-2">
                  {followingList.map((f) => {
                    ...
                    return (
                      ...
                      >
                        {f.photoURL ? (
                          <img src={f.photoURL} alt="" className="h-6 w-6 rounded-lg object-cover" />
                        ) : (
          ...
          <div className="border-t border-[var(--card-border)] pt-4">
            <Link
              href="/profile/settings"
              className="flex min-h-[44px] items-center justify-between rounded-xl border border-[var(--card-border)] bg-[var(--card)] px-4 py-3 text-sm font-semibold text-[var(--foreground)] transition hover:border-sky-500/25 hover:bg-[var(--card-hover)]"
            >
