        ...
        <div className="flex items-center gap-4">
          ...
          {user && (
            <nav className="hidden lg:flex items-center gap-1 text-sm font-medium">
              <Link href="/post/ai" className={`relative px-3 py-2 rounded-lg transition-all duration-200 ${isActive("/post/ai") ? "text-sky-300 bg-sky-500/10" : "text-[var(--nav-ice-muted)] hover:text-[var(--nav-ice)] hover:bg-white/[0.04]"}`}>
                Sell
              ...
              <div className="relative group px-1">
                <button className={`flex items-center gap-1 px-3 py-2 rounded-lg transition-all duration-200 cursor-pointer ${isActive("/digital") || isActive("/services") || isActive("/rentals") || isActive("/wanted") || pathname === "/" ? "text-[var(--nav-ice)] bg-white/[0.04]" : "text-[var(--nav-ice-muted)] hover:text-[var(--nav-ice)] hover:bg-white/[0.04]"}`}>
                  <span>Browse</span>
              ...
              <Link href="/list-list" className={`relative px-3 py-2 rounded-lg transition-all duration-200 ${isActive("/list-list") ? "text-sky-300 bg-sky-500/10" : "text-[var(--nav-ice-muted)] hover:text-[var(--nav-ice)] hover:bg-white/[0.04]"}`}>
                My Listings
              ...
              <Link href="/watchlist" className={`relative px-3 py-2 rounded-lg transition-all duration-200 ${isActive("/watchlist") ? "text-sky-300 bg-sky-500/10" : "text-[var(--nav-ice-muted)] hover:text-[var(--nav-ice)] hover:bg-white/[0.04]"}`}>
                Watchlist
              ...
              <Link href="/purchases" className={`relative px-3 py-2 rounded-lg transition-all duration-200 ${isActive("/purchases") ? "text-sky-300 bg-sky-500/10" : "text-[var(--nav-ice-muted)] hover:text-[var(--nav-ice)] hover:bg-white/[0.04]"}`}>
                Purchases
              ...
              <Link href="/sales" className={`relative px-3 py-2 rounded-lg transition-all duration-200 ${isActive("/sales") ? "text-sky-300 bg-sky-500/10" : "text-[var(--nav-ice-muted)] hover:text-[var(--nav-ice)] hover:bg-white/[0.04]"}`}>
                Sales
          ...
          {mobileMenuOpen && (
            <div className="absolute top-full left-0 right-0 z-50 border-b border-white/[0.06] bg-zinc-950/98 backdrop-blur-2xl md:hidden animate-fade-in-up shadow-2xl shadow-black/40">
              <div className="flex flex-col gap-1 p-3 max-h-[80vh] overflow-y-auto">
                ...
                <Link href="/post/ai" className={`flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-bold transition-colors ${isActive("/post/ai") ? "text-sky-300 bg-sky-500/10" : "text-[var(--nav-ice)] hover:bg-white/[0.06] active:bg-white/[0.08]"}`} onClick={() => setMobileMenuOpen(false)}>
                ...
                {user ? (
                  ...
                  <>
                    <Link href="/login" className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-bold text-[var(--nav-ice)] hover:bg-white/[0.06] active:bg-white/[0.08] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                      <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-500/10 text-sm">🔐</span>
                      Login
                    </Link>
                    <Link href="/login?signup=1" className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-bold text-sky-400 hover:bg-white/[0.06] active:bg-white/[0.08] transition-colors" onClick={() => setMobileMenuOpen(false)}>
                      <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-500/10 text-sm">✨</span>
                      Create Account
                    </Link>
                  </>
          ...
          <div className="hidden md:flex items-center gap-2">
            {user ? (
              <div className="relative group">
                <button className={`inline-flex items-center gap-2 rounded-xl border border-white/[0.06] px-3 py-2 text-sm font-bold transition-all duration-200 active:scale-[0.97] ${isActive("/profile") ? "text-sky-300 border-sky-500/30 bg-sky-500/10" : "text-[var(--nav-ice)] hover:border-sky-500/30 hover:bg-sky-500/10 hover:text-sky-200"}`}>
