      ...
      <section className="relative z-10 mx-auto max-w-[1800px] px-4 pb-10 pt-6">
        <div className="mb-10 relative overflow-hidden rounded-3xl border border-white/[0.04] bg-gradient-to-b from-white/[0.04] via-transparent to-transparent p-8 sm:p-10 text-center">
          ...
          <div className="relative flex flex-col items-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-violet-500/15 bg-violet-500/5 px-3.5 py-1 text-[10px] font-semibold text-violet-400 mb-4 tracking-wide uppercase">
              Freelance Services
            </div>
                ...
                <div className="grid gap-2.5 sm:grid-cols-2">
                  <div className="flex gap-2">
                    ...
                    <div className="min-w-0">
                      <p className="text-[11px] font-bold text-[var(--foreground)]">Browse & Choose</p>
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="min-w-0">
                      <p className="text-[11px] font-bold text-[var(--foreground)]">Service Delivered</p>
                      <p className="mt-0.5 text-[10px] leading-snug text-zinc-500">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="min-w-0">
                      <p className="text-[11px] font-bold text-[var(--foreground)]">Discuss Scope</p>
                      <p className="mt-0.5 text-[10px] leading-snug text-zinc-500">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="min-w-0">
                      <p className="text-[11px] font-bold text-[var(--foreground)]">Agree & Pay</p>
                      <p className="mt-0.5 text-[10px] leading-snug text-zinc-500">
        ...
        {listings.length === 0 ? (
          <div className="mx-auto max-w-md mt-12 text-center">
            ...
            <p className="mt-2 text-sm text-zinc-500">Be the first to list a service.</p>
            <Link
              href="/post/ai?type=service"
