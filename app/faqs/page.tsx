...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Why do I need to verify my email and phone?", a: "Email verification is required before creating listings or buying. Phone verification is optional but recommended — it adds a Verified badge to your listings. Seller verification (KYC) is required before you can list items for sale." },
