...
const faqs = [
  ...
  },
  {
    ...
    items: [
      { q: "How do I sign up?", a: "Click 'Get Started' on the homepage. Sign up with your email. You'll need to verify your email and provide a phone number to create your account." },
      { q: "Why do I need to provide a phone number?", a: "Phone verification helps prevent fake accounts and makes it harder for scammers to create unlimited accounts. Your phone number is stored securely and is not shared publicly." },
      { q: "Why do I need to verify my email and phone?", a: "To help prevent fraud and fake accounts, users must verify their email address and phone number before accessing marketplace features. Additional verification may be required for selling privileges." },
      { q: "What is KYC verification?", a: "KYC (Know Your Customer) is identity verification for sellers. Completing KYC allows you to list items immediately. If you choose not to complete KYC, you'll need to wait before you can start selling. KYC helps prevent fraud and ensures buyers know they're dealing with real, accountable people." },
